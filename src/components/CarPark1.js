        ...
        <div className='carlot1' style={{}}>
          {parkingDetails.map((lot, index) => (
            <div
              ...
              className='carpark'
              name='car1'
              onClick={() => (lot.status ? store(lot.id) : selectPath(lot.id))}
              style={lot.status ? { backgroundColor: 'red' } : { backgroundColor: 'green' }}
            >
              {lot.id}
            </div>
          ))}
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id='alert-dialog-description'>
            <p>
              <strong>Parking Bay: {parkingBay}</strong>
            </p>
            <p>Mall: {mall.mall}</p>
            ...
            <p>
              <strong>
                ⚠ Add this to find my car park!
                <DriveEtaIcon style={{ paddingTop: '7px', fontSize: '1.5em' }} fontSize='large' />
              </strong>
            </p>
          </DialogContentText>
        </DialogContent>
